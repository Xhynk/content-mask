	...
	<div id="content-mask-options" class="content-mask-admin-panel">
		...
		<div class="content-mask-option">
			<label class="content-mask-checkbox" for="content_mask_tracking" data-attr="<?php echo $tracking_enabled; ?>">
				<span aria-label="Enable Content Mask Tracking"></span>
			...
			<span class="content-mask-option_label">Content Mask Visitor Tracking is <strong class="content-mask-value"><?php echo ucwords( $tracking_enabled ); ?></strong></span>
		</div>
	</div>
